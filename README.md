...
Завдання:
    ...
    Додай анімацію декоративних ефектів для сторінок макета https://www.figma.com/file/1ehrLBauvVFu4mVhxsHzyZ/Web-Studio-(Version-2.1)?node-id=1%3A2125&t=RRsVwsYcpAQZNKsO-0.
...
«A5» Код написаний з дотриманням https://codeguide.co/.
